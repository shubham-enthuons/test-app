angular.module("recipeAppMobile").controller("recipeCtrlMobile", function ($scope ,$sce,$route,$document,$translate,$location,$window,$rootScope, $routeParams, $http , $timeout, checkDomChange){
...
"showGoogle": true
  ...
  function printDiv() {
    ...
    //  WinPrint.document.getElementById("socialSharebutton").style.visibility="hidden";
   ...
   // WinPrint.document.getElementById("hideVedio").style.display="none";
