...
<head>
	<meta charset="utf-8">
	<title>Wix openapi-node Class: ActivityType</title>
...
<div class="container-fluid">
	...
	<h1 class="page-title">Class: ActivityType</h1>
<section>
...
<dt>
    <h4 class="name" id="ActivityType"><span class="type-signature"></span>new ActivityType<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>Represents a Wix Activity Type, representing both the schema definition and the Wix Activity name</p>
    </div>
...
<dd>
    ...
    <div class="description">
        <p>The name of the Activity Schema</p>
    </div>
...
<dt>
    <h4 class="name" id="schema"><span class="type-signature">&lt;readonly> </span>schema<span class="type-signature"></span></h4>
...
<dd>
    ...
    <div class="description">
        <p>The path to the Activity JSON Schema</p>
    </div>
