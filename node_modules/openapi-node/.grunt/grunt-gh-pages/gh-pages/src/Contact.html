...
<dt>
    <h4 class="name" id="update"><span class="type-signature"></span>update<span class="signature">(contact)</span><span class="type-signature"> &rarr; {Promise.&lt;Object, error>}</span></h4>
