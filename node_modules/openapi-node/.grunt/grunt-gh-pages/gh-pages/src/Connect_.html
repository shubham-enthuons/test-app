...
<dt>
    <h4 class="name" id="parseInstance"><span class="type-signature">&lt;static> </span>parseInstance<span class="signature">(instance, secret, validator)</span><span class="type-signature"> &rarr; {<a href="Connect_.html#WixInstanceData">module:Wix/Connect.WixInstanceData</a>}</span></h4>
