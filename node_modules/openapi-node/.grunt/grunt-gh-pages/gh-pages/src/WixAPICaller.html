...
<head>
	<meta charset="utf-8">
	<title>Wix openapi-node Class: WixAPICaller</title>
...
<div class="container-fluid">
	...
	<h1 class="page-title">Class: WixAPICaller</h1>
<section>
...
<dt>
    <h4 class="name" id="WixAPICaller"><span class="type-signature"></span>new WixAPICaller<span class="signature">()</span><span class="type-signature"></span></h4>
...
<dt>
    <h4 class="name" id="Scope"><span class="type-signature">&lt;readonly> </span>Scope<span class="type-signature"> :string</span></h4>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The full site</p></td>
        </tr>
...
<span class="param-type">string</span>
            ...
            <td class="description last"><p>The calling application</p></td>
        </tr>
